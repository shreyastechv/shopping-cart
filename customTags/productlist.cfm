...
<cfoutput>
	<div class="d-flex flex-wrap px-3 py-1">
		<cfloop query="attributes.qryProducts">
			<div onclick="location.href='/productPage.cfm?productId=#attributes.qryProducts.fldProduct_Id#'" role="button" class="pe-auto w-16 d-flex flex-column align-items-center border rounded border-dark mb-3">
